...
## Project Structure
    ...
    ├── testapiautostorybo_119548  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_119548`
...
2. Clone this repo and `cd testapiautostorybo_119548`
